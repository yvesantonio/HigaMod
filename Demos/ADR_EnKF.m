...
%                                  +(0.2*x.^5-0.5*x.^2).*sin(2*pi*(y+0.5)).*0.05;
    ...
    numbEnsembles = [numbEnsembles 2000:1000:5000];
    
    numbEnsembles = [500 900 1800 2700;
                     500 1000 1500 3000;
                     500 1000 2000 3000;
                     500 1000 2000 3000;];
    ...
    %% Equation Solver
        ...
        %-------------------------------------------------------------------------%
            ...
            obj_solverEnKF.couplingCond_DD = 'RR';
            ...
            [solutionMatrix,noisyMeasure,estimateMatrix,...
             condGain,fTime] = solverEnKF(obj_solverEnKF);

             
%         fid = fopen(['condGain_m',num2str(ll),'_h',num2str(pp),'.txt'],'wt');
%         for ii = 1:size(condGain,1)
%         fprintf(fid,'%.15f \t',condGain(ii,:));
%         fprintf(fid,'\n');
%         end
%         fclose(fid);
