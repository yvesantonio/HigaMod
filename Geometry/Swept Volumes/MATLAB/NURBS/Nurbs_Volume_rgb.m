...
%%
plot3(P(:,1,1,1), P(:,1,1,2),P(:,1,1,3),'kd',P(:,1,2,1), P(:,1,2,2),P(:,1,2,3),'kd',P(:,1,3,1), P(:,1,3,2),P(:,1,3,3),'kd','LineWidth',3);grid on;hold on
plot3(P(:,2,1,1), P(:,2,1,2),P(:,2,1,3),'kd',P(:,2,2,1), P(:,2,2,2),P(:,2,2,3),'kd',P(:,2,3,1), P(:,2,3,2),P(:,2,3,3),'kd','LineWidth',3);grid on