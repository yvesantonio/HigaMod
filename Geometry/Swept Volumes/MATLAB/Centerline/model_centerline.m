...
% vmtkcenterlines -ifile C:/Users/Leo/Desktop/pipe_mod.stl  -ofile C:/Users/Leo/Desktop/cent_pipe.dat 
%% load data .dat , need to run the vmtk to get the .dat file
A=importdata('C:\Users\Leo\Desktop\model_cent_prova.dat');
...
%%
[Cpt]=nrb_approx(x,y,z,40,3,1.e-10,30,100);
x=Cpt(1,:);
y=Cpt(2,:);
z=Cpt(3,:);
clearvars Cpt
