function [Map]=provideMapUnsteady(haty)
...
a_up=sym2fxt(a_up);
a_down=sym2fxt(a_down);
haty=sym2fxyt(haty);
D=sym2fxyt(D);
J=sym2fxyt(J);
Jac=sym2fxyt(Jac);
invhaty=sym2fxyt(invhaty);
w=sym2fxyt(w);
Map=struct('haty',haty,'invhaty',invhaty,'D',D,'J',J,'jac',Jac,'a_up',a_up,'a_down',a_down,'w',w);
end