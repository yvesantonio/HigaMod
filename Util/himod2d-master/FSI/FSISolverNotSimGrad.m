function sol=FSISolverNotSimGrad(mesh,quad,Data,out)
        ...
        for k = 1:mx
            ...
            for r = 1:mx
                ...
                [ Ax(1+(r-1)*fedof : r*fedof , 1+(k-1)*fedof : k*fedof), ...
                    ...
                    AssembleVel1DXNotSym(Map,weights_yhat, MbKX, MbRX,DMbKX,DMbRX,ne,...
        ...
        for k = 1:my
            ...
            for r = 1:my
                ...
                [ Ay(1+(r-1)*fedof : r*fedof , 1+(k-1)*fedof : k*fedof), ...
                    ...
                    FSIAssembleVel1DYNotSym(Map,weights_yhat, MbKY, MbRY,DMbKY,DMbRY,ne,...
