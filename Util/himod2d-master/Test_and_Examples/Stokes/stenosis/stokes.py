...
CUX=np.linspace(0.0,0.5,15);
CUXt=np.linspace(-0.1,0.5,11);
plt.subplot(3,2,(1,2))
...
CUY=np.linspace(-0.15,0.15,10);
CUYt=np.linspace(-0.15,0.15,11);
plt.subplot(3,2,(3,4))
...
CP=np.linspace(-0.5,5.5,15)
CPt=np.linspace(-1,6,11)
plt.subplot(3,2,(5,6))
