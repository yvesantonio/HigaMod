...
% forzante:                                    %
%**********************************************%
force = @(x,y) 10*(  ((x-1.).^2+(y-0.5).^2<=0.01));
%force = @(x,y) 10*(  (x-1<=0.01).*(y<=0.6).*(y>=0.4)).*(x-1>=-0.01);
%**********************************************%
...
beta1 = @(x,y) ( beta + 0*x+0*y ); % Trasporto orizzontale
...
gamma=struct ('L',NaN,'R',NaN); % for the coupling
%***********************************************%
%                    SOLVER                     %
%***********************************************%
