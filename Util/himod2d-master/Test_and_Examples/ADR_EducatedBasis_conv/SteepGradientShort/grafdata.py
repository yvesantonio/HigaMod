...
archi_x = open('himod1.out','r')
archi_x1 = open('himod2.out','r')
archi_x2 = open('himod3.out','r')
archi_f = open('himod4.out','r')
...
plt.subplot(8,1,(1,2))
C=plt.contourf(xx, yy, ua, 10)
plt.ylabel(r'$\beta$=10')
plt.colorbar(C,use_gridspec=True)
plt.grid()

plt.subplot(8,1,(3,4))
plt.contourf(xx, yy, ua1, 10)
...
plt.subplot(8,1,(5,6))
plt.contourf(xx, yy, ua2, 10)
plt.ylabel(r'$\beta$=1000')
plt.colorbar(C,use_gridspec=True)
plt.grid()


plt.subplot(8,1,(7,8))
plt.contourf(xx, yy, ufem, 10)
plt.ylabel(r'$\beta$=10000')
plt.colorbar(C,use_gridspec=True)
plt.grid()

#plt.show
plt.tight_layout()
plt.savefig('Steep.eps',format='eps',transparent='true')
plt.savefig('Steep.png',format='png',transparent='true')
