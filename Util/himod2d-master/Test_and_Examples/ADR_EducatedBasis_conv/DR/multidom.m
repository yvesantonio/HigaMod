...
bc_up={ BC_laterali_up BC_laterali_up BC_laterali_up };
dato_up={dato_dir_up dato_dir_up dato_dir_up};
bc_down={ BC_laterali_down BC_laterali_down BC_laterali_down};
dato_down={chi*0.06 chi*0.06 chi*0.06};
