...
archi_x = open('himod10fff.out','r')
archi_x1 = open('himod100fff.out','r')
archi_x2 = open('himod1000fff.out','r')
archi_f = open('himod10000fff.out','r')
...
plt.subplot(8,1,(1,2))
C=plt.contourf(xx, yy, ua, 20,vmin=vm,vmax=vM)
...
plt.subplot(8,1,(7,8))
plt.contourf(xx, yy, ufem, 20,vmin=vm,vmax=vM)
