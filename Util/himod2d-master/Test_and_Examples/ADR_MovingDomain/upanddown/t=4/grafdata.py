...
archi_x  = open('m=4h005.out','r')
archi_x1 = open('m=8h005.out','r')
archi_x2 = open('m=16h005.out','r')
archi_f  = open('ffh001.out','r')
...
plt.ylabel(r'm=4')
plt.yticks(np.arange(-1, 1.8, 0.4))
...
#plt.show
plt.tight_layout()
plt.savefig('Upanddown.eps',format='eps',transparent='true')
plt.savefig('Upanddown.png',format='png',transparent='true')
