function [errL2,errH1,CutCoord] = plot_solution_IGA_scatter_stab(size_mb,a_ril,b_ril,cutx,...
    ...
    export_fig(sprintf([ 'H' num2str(simulationInfo.H) '_M' num2str(simulationInfo.M) '_Pe' num2str(simulationInfo.Pe) '_Dlt' num2str(simulationInfo.Delta) '_' Method '_HigaContour']),'-pdf');
    ...
    export_fig(sprintf([ 'H' num2str(simulationInfo.H) '_M' num2str(simulationInfo.M) '_Pe' num2str(simulationInfo.Pe) '_Dlt' num2str(simulationInfo.Delta) '_' Method '_HigaSurf']),'-pdf');
