...
%                 errorNormL2 = errL2;
            ...
            %% Method 'solverIGAScatterWeak'
            
            function [u,liftCoeffA,liftCoeffB,errorNormL2,errorNormH1] = solverIGAScatterWeak(obj)
                ...
                [A,b,~,liftCoeffA(1),liftCoeffB(1),space,refDomain1D,boundStruct] = buildSystemIGAScatterWeak(build_IGA); 
...
%                 errorEstimatedL2 = zeros(numbSamples-1,1);
            ...
            function [errStruct] = solverIGAScatterStokes(obj)
                ...
                [AA,FF,plotStruct] = buildSystemIGAScatter(build_IGA); 
...
%                 errStruct = 0;
            ...
            %% Method 'solverIGAScatterStokesTransient'
            
            function [] = solverIGAScatterStokesTransient(obj)
                ...
                [AA,MM,FF,plotStruct] = buildSystemIGAScatterTransient(build_IGA); 
