...
%                 [evalPoints,~] = gauss(numbHorNodes);
            ...
            %% COMPUTE BOUNDARY CONDTIONS
            %-------------------------------------------------------------%
            % Compute the projection of the boundary conditions in the
            % hierarchcally reduced problems.
            %-------------------------------------------------------------%
            ...
            [infStruct,outStruct] = computeFourierCoeff(obj_liftBoundCond);
